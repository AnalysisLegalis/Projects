...
<p>Как решала(-а):
1.1) На основании данных за 2021 год произвел расчет основных метрик (Средний Retention за период,Lifetime (месяцы), Средняя интенсивность, Lifetime (уроки), Средняя цена урока, LTR, 
